window.addEventListener('load', function load() {
    ...
    function wireControls() {
      ...
      var flipClasses = function(evt) {
        ...
        document.getElementsByTagName('main')[0].classList.add(evt.target.value);
        document.getElementsByTagName('footer')[0].classList.add(evt.target.value);
        return false;
      };
    ...
    function sliceTime() {
        ...
        msInA.month = msInA.day * MONTH_DAYS[current.month];
        ...
        upToThis.month = (current.month * msInA.month) + upToThis.date;
